...
{
    ////////////////////////////////////////////////////////////
    /// \brief Specialized shape representing a semicircle
    ///
    ////////////////////////////////////////////////////////////
    ...
    public:
        ...
        ///
        ////////////////////////////////////////////////////////////
        explicit SemiCircle(float radius = 0, std::size_t pointCount = 30) : m_texture(NULL),
                                                                             m_textureRect(),
        ...
        virtual Vector2f getPoint(std::size_t index) const
        {
            ...
            float angle = static_cast<float>(index) * pi / static_cast<float>(m_pointCount) - pi / 2.f;
        ...
        void update()
        {
            ...
            m_vertices.resize(count + 3); // + 3 for center, repeated first point and symmetry point to first point

            // Position
            for (std::size_t i = 0; i < count+1; ++i)
                m_vertices[i + 1].position = getPoint(i);
            m_vertices[count + 2].position = m_vertices[1].position;
    ...
    private :
        ...
        FloatRect m_bounds;            //!< Bounding rectangle of the whole shape (outline + fill)s
...
/// (position, rotation, scale, bounds, ...) and remake sf::Shape function
///
/// Usage example:
/// \code
/// sf::SemiCircle semicircle;
/// semicircle.setRadius(150);
/// semicircle.setOutlineColor(sf::Color::Red);
/// semicircle.setOutlineThickness(5);
/// semicircle.setPosition(10, 20);
/// ...
/// window.draw(semicircle);
/// \endcode
///
/// Since the graphics card can't draw perfect semicircles, we have to
